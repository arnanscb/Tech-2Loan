...
public class LoanControllerTest {
    ...
    void testGetLoanInfoByIdEqual1() throws Exception {
        ...
        JSONObject reps = new JSONObject(mvcResult.getResponse().getContentAsString());
        JSONObject status = new JSONObject(reps.getString("status"));
        JSONObject data = new JSONObject(reps.getString("data"));
